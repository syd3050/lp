...
if(!function_exists('uri_for'))
{
    ...
    function uri_for($uri)
    {
        if ($uri instanceof \Psr\Http\Message\UriInterface) {
            ...
            return new \core\request\Uri($uri);
        }
...
if(!function_exists('stream_for'))
{
    ...
    function stream_for($resource = '', array $options = [])
    {
        if (is_scalar($resource)) {
            ...
            return new \core\stream\Stream($stream, $options);
        }
        switch (gettype($resource)) {
            case 'resource':
                return new \core\stream\Stream($resource, $options);
            case 'object':
                if ($resource instanceof \Psr\Http\Message\StreamInterface) {
                    return $resource;
                } elseif ($resource instanceof \Iterator) {
                    return new \core\stream\PumpStream(function () use ($resource) {
                        if (!$resource->valid()) {
                            return false;
                        }
                ...
                break;
            case 'NULL':
                return new \core\stream\Stream(fopen('php://temp', 'r+'), $options);
        }
        if (is_callable($resource)) {
            return new \core\stream\PumpStream($resource, $options);
        }
...
if(!function_exists('parse_header'))
{
    /**
...
if(!function_exists('modify_request'))
{
    /**
     ...
     *
     * @param \Psr\Http\Message\RequestInterface $request Request to clone and modify.
    ...
    function modify_request(\Psr\Http\Message\RequestInterface $request, array $changes)
    {
        ...
        if ($request instanceof \Psr\Http\Message\ServerRequestInterface) {
            return new \core\request\ServerRequest(
...
if(!function_exists('rewind_body'))
{
    /**
     ...
     * value other than `0`.
     *
     * @param \Psr\Http\Message\MessageInterface $message Message to rewind
     *
...
if(!function_exists('copy_to_string'))
{
    /**
...
if(!function_exists('copy_to_stream'))
{
    /**
...
if(!function_exists('hash'))
{
     ...
     *
     * @param \Psr\Http\Message\StreamInterface $stream    Stream to calculate the hash for
...
if(!function_exists('mimetype_from_filename'))
{
    /**
...
if(!function_exists('mimetype_from_extension'))
{
    /**
...
if(!function_exists('_parse_message'))
{
    /**
...
if(!function_exists('_parse_request_uri'))
{
    /**
...
if(!function_exists('get_message_body_summary'))
{
     ...
     *
     * @param \Psr\Http\Message\MessageInterface $message    The message to get the body summary
...
if(!function_exists('_caseless_remove'))
{
...
if(!function_exists('removeDotSegments'))
{
...
{
    function resolve(\Psr\Http\Message\UriInterface $base, \Psr\Http\Message\UriInterface $rel)
    {
        if ((string) $rel === '') {
        ...
        if ($rel->getScheme() != '') {
            return $rel->withPath(removeDotSegments($rel->getPath()));
        }
        if ($rel->getAuthority() != '') {
            $targetAuthority = $rel->getAuthority();
            $targetPath = removeDotSegments($rel->getPath());
        ...
        return new \core\request\Uri(\core\request\Uri::composeComponents(
            $base->getScheme(),
            $targetAuthority,
            $targetPath,
            $targetQuery,
